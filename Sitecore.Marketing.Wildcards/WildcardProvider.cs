...
namespace Sitecore.Marketing.Wildcards
{
    ...
    public class WildcardProvider:ProviderBase
    {
        ...
        {
            get { return "/sitecore/system/Modules/Wildcards/Routes"; }
        }

        private const string QUERY_ROUTE = "/sitecore/system/Modules/Wildcards/Routes/*[contains(@Items, '{0}')]";
        ...
        protected virtual WildcardRuleContext RunRules(Item item, SiteContext site)
        {
            ...
            var query = string.Format(QUERY_ROUTE, item.ID.ToString());
